package com.holograin.warrens.block.custom;
...
public class MagicBlock extends Block {
    ...
    @Override
    protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos blockPos,
                                               Player player, BlockHitResult hitResult) {
        level.playSound(player, blockPos, SoundEvents.DONKEY_DEATH, SoundSource.BLOCKS, 1f, 1f);
